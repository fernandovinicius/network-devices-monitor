...
async def update_device_info(cursor, data: Device):
...
async def insert_new_history(cursor, data: DeviceStatusHistory):
...
async def increment_count_history(cursor, history_id: int):
    await cursor.execute(
        """
